...
const BestOfferCard = ({ item }) => {
    ...
    return (
        <motion.div
            ...
            className="w-[45%] pb-1.5 relative my-2 mx-0.5 cursor-pointer flex flex-col md:w-3/12 lg:w-[21%] md:mx-2 border bg-white border-gray-200 rounded-lg overflow-hidden max-h-[280px] min-h-[280px] hover:shadow-xl hover:scale-105"
        >
            {existingItem?.q > 0 && (
            ...
            <Link
                href={`/itemtype/${item.type}/?item=${item._id}`}
